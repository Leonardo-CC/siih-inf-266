// src/pages/admin/AdminMedicamentos.jsx
// ============================================================
// CRUD de medicamentos (rol: administrativo).
// ============================================================
...
export default function AdminMedicamentos() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.log('Respuesta guardado medicamento (admin):', out);
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button
          onClick={abrirCrear}
          className="bg-primary hover:bg-primary-dark text-white font-medium py-2.5 px-4 rounded-lg shadow-sm flex items-center gap-2 transition"
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-lg p-3 flex items-start gap-2">
            ...
            <p className="text-xs text-amber-800">
              El stock inicial es <strong>0</strong>. Para agregar existencias, usa el ingreso de lotes desde la sección de Inventario o Movimientos.
            </p>
          </div>
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button type="submit" disabled={enviando} className="px-6 py-2.5 bg-primary hover:bg-primary-dark text-white font-semibold rounded-lg transition disabled:opacity-50">
